...
(async () => {
  ...
  await page.goto('https://wiki.archlinux.org', { waitUntil: 'domcontentloaded', timeout: 15000 });
  ...
  console.log('Top tags:', Object.entries(allTags).sort((a,b) => b[1]-a[1]).slice(0, 10));
