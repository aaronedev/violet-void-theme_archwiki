...
(async () => {
  ...
  const checks = await page.evaluate(() => {
    ...
    const panels = document.querySelectorAll('.mw-panel, #mw-panel, .vector-sticky-pills-container');
    ...
    // Check nav/menu
    const nav = document.querySelector('.vector-nav, .vector-sticky-pills-container');
    if (nav) {
